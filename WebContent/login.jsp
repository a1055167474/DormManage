...
<div class="container">
      ...
      <font color="red"><center>
        ...
        <input type="text" placeholder="请输入验证码" class="login_username" name="CHECK_CODE_PARAM_NAME"><br>
        <img alt="" src="<%= request.getContextPath()%>/validateColor" ><br>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <!--<button class="btn btn-large btn-primary" type="button" >重置</button><br><br>-->
        <button class="btn btn-large btn-primary" type="button" onclick="javascript:window.location='student?action=register'">注册</button>
