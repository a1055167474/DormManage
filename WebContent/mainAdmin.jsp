...
.div-left{width:228px;height:37.6px;border:1px solid #000;float:left;border:1px solid #FFF}
</style>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span2 bs-docs-sidebar" >
				...
				<div class="div-left">
				<ul class="nav nav-list bs-docs-sidenav">
				<li><a href="fileload?action=list"><i class="icon-chevron-right"></i>文件管理</a></li>
				</ul>
			</div>
			</div>
