...
<div class="data_list">
		...
		<form action="student?action=registersave" method="post" onsubmit="return checkForm()">
			<div class="data_form" >
				<input type="hidden" id="studentId" name="studentId" value="${student.studentId }"/>
					...
					<div align="center">
						...
						&nbsp;<a href="login.jsp"><button class="btn btn-primary" type="button" onclick="javascript:window.location='registersave'">返回</button></a>
					</div>
					<div align="center">
